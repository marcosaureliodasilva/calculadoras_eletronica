...
function decide(){
V1=parseFloat(document.formu3.nt1.value);
V2=parseFloat(document.formu3.nt2.value);
W2=parseFloat(document.formu1.t3.value);
F=parseFloat(document.formu1.t4.value);
...
PC=SC*LM*8.9/100;
document.formu4.nresu2.value=I1+" A";
document.formu4.nresu3.value=I2+" A";
document.formu4.nresu4.value=D+" A/mm2";
document.formu4.nresu5.value=SF1+" mm2";
document.formu4.nresu6.value=SF2+" mm2";
